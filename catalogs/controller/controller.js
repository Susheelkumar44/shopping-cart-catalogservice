...
//registerProduct - Handler to create product
exports.registerProduct = async (req, res) => {
    try {
        const savedProduct = await repository.createProduct(req.body);
        res.set({
...
//editHandler - Handler to edit single product based on ID
exports.editHandler = async (req, res) => {
    try {
        const product = await repository.getProductById(req.params.productID);
        if (product == null) {
            throw "No Data"
        }
        const editedProduct = await repository.editProduct(req.params.productID, req.body);
